...
// 🌡️ ألوان النمط الحراري (Thermal Pattern)
...
// 🎨 Logo & Branding
export const LOGO = {
  // Logo Icon Only (for small spaces, favicons)
  icon: '/assets/logo-icon.png',
  
  // Logo with Text (for navbar, headers)
  full: '/assets/logo-full.png',
  
  // Logo variations
  light: '/assets/logo-full-light.png',  // للخلفيات الداكنة
  dark: '/assets/logo-full-dark.png',    // للخلفيات الفاتحة
  ...
  // Sizes
  sizes: {
    xs: { width: 24, height: 24 },   // Favicon, mobile icon
    sm: { width: 32, height: 32 },   // Small buttons
    md: { width: 48, height: 48 },   // Navbar
    lg: { width: 64, height: 64 },   // Page headers
    xl: { width: 128, height: 128 }, // Landing page, hero
    '2xl': { width: 256, height: 256 } // About page, branding
  },
  
  // Logo meaning (for team reference)
  symbolism: {
...
// 🎨 Brand Colors (extracted from NEW logo v5 - with gradient text!)
export const BRAND_COLORS = {
  // من بداية النص "T" - Cold
  coldBlue: {
    light: '#38BDF8',
    main: '#0EA5E9',
    dark: '#0284C7'
  ...
  // من التدرج الأوسط "g" - Transitioning
  warmPurple: {
    light: '#A78BFA',
    main: '#8B5CF6',
    dark: '#7C3AED'
  ...
  // التدرج الكامل (من النص "Triggerio")
  thermalGradient: {
    start: '#0EA5E9',
    cool: '#3B82F6',
    transition: '#8B5CF6',
